...
lines = [
  ...
  '',
  '## Project structure',
  '- .kiro/specs/product-launch-package/requirements.md is the authoritative requirements source; prefer it over top-level equirements.md.',
  '- .kiro/steering/ holds product, structure, and tech notes that should be revisited as implementation details emerge.',
  '- The repository currently contains only planning documents; update 	ech.md with actual stack/commands once code appears.'
]
